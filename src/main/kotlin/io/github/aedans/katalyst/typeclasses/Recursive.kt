...
interface Recursive<T> : TC {
     ...
     */
    fun <F, M, A> cataM(t: HK<T, F>, alg: AlgebraM<M, F, A>,
     ...
     */
    fun <F, W, A> gcata(t: HK<T, F>, dFW: DistributiveLaw<F, W>, alg: GAlgebra<W, F, A>,
     ...
     */
    fun <F, W, M, A> gcataM(t: HK<T, F>, dFW: DistributiveLaw<F, W>, alg: GAlgebraM<W, M, F, A>,
     ...
     */
    fun <F, A> para(t: HK<T, F>, alg: GAlgebra<PairKWKindPartial<HK<T, F>>, F, A>,
                    FF: Functor<F>): A =
     ...
     */
    fun <F, M, A> paraM(t: HK<T, F>, alg: GAlgebraM<PairKWKindPartial<HK<T, F>>, M, F, A>,
                        TF: Traverse<F>, MM: Monad<M>): HK<M, A> =
